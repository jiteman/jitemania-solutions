...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
private:
	Executable_class( Executable_class const &another ) noexcept = delete;
	Executable_class &operator =( Executable_class const &another ) noexcept = delete;
