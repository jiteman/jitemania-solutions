...
class JSD_derived_library_template_SHARED_INTERFACE Derived_class :
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
private:
	Derived_class( Derived_class const &another ) noexcept = delete;
	Derived_class &operator =( Derived_class const &another ) noexcept = delete;
